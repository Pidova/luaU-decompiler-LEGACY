...
#define routine_inc_safe(node, routine) routine += node->count_expr<ast_dec::expr_type::concat_routine_start>() + node->count_expr<ast_dec::expr_type::call_routine_start>() + node->count_expr<ast_dec::expr_type::table_start>()
#define routine_dec_safe(node, routine) routine -= node->count_expr<ast_dec::expr_type::concat_routine_end>() + node->count_expr<ast_dec::expr_type::call_routine_end>() + node->count_expr<ast_dec::expr_type::table_end>()
...
#define condition_break(node) (node->has_expr(ast_dec::expr_type::break_) ||          \
                               ...
                               node->lex->type == lexer_dec::inst_type::return_ ||    \
